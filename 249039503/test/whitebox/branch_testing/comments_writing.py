...
class CommentsWritingBranchTest(unittest.TestCase):
    ...
    def test_line_comment_after_expression(self):
        code = "1 + 2; // trailing comment"
        self.assertEqual(run(code), 3)

    def test_line_comment_after_statement_followed_by_new_statement(self):
        code = """
        1 + 2; // comment
        3;
        """
    ...
    def test_comment_markers_inside_string_not_comment(self):
        code = r"""
        let s = "not a // comment";
        1 + 2;
        """
